...
export const getPublication = async (publication_id: string) => {
    return await get({ url: `${VITE_REST_API}:8003/publication`, options: { params: { id: publication_id } } });
};
...
export const postPublicationDate = async (publicationDate: Object) => {
  return await post({ url: `${VITE_REST_API}:8003/publicationDate/new`, data: { publicationDate }, options: {} });
};

export const putPublicationDate = async (publicationDate: Object) => {
  return await put({ url: `${VITE_REST_API}:8003/publicationDate/update`, data: { publicationDate }, options: {} });
};
